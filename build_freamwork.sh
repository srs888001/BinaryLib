...
# framework
DEVICE_DIR=${BUILD_PATH}/Release-iphoneos/lib${BINARY_NAME}.framework
SIMULATOR_DIR=${BUILD_PATH}/Release-iphonesimulator/lib${BINARY_NAME}.framework
...
lipo -create "${DEVICE_DIR}" "${SIMULATOR_DIR}" -output "${INSTALL_LIB_DIR}/lib${PROJECT_NAME}"
# rm -r "${WRK_DIR}"
